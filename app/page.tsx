...
// export default function Home() {
//   return (
//     <div className="min-h-screen text-white p-8 sm:p-20 flex flex-col items-center justify-center gap-10">
//       <main className="text-center max-w-2xl">
//         <h1 className=" text-4xl sm:text-6xl mb-4 tracking-wide">
//           MakeCU 2025
//         </h1>
//         <p className=" text-lg sm:text-xl text-gray-300 mb-6">
//           Columbia University Robotics Club's Hardware Hackathon. November 8–9th, 2025.
//         </p>
//         <a
//           href="#"
